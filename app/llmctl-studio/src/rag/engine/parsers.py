...
from rag.engine.code_spans import detect_language, spans_for_language
...
from rag.engine.pdf_pipeline import parse_pdf
...
def build_parser_registry():
    from rag.engine.pipeline import ParserRegistry
